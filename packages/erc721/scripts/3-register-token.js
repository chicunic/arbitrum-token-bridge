...
async function main() {
  ...
  const l1Token = await L1Token.connect(l1Signer).deploy();
  await l1Token.deployed();
  console.log('1-1: L1 ERC721 deployed to:', l1Token.address);
  ...
  console.log('1-2: L2 ERC721 deployed to:', l2Token.address);
  ...
  const l1SetTx = await l1ERC721Gateway.forceRegisterTokenToL2(
    [l1Token.address],
    [l2Token.address],
    maxGas,
    gasPriceBid,
