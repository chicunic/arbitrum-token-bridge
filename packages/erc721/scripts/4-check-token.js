...
async function main() {
  ...
  console.log('4 - Check ERC721 registration');
  ...
  {
    const l2TokenAddress = await l1ERC721Gateway.calculateL2TokenAddress(token1);
    console.log('Original L2 ', token2);
    console.log('Calculate L2', l2TokenAddress);
  }

  {
    const l2TokenAddress = await l2ERC721Gateway.calculateL2TokenAddress(token1);
    console.log('Original L2 ', token2);
    console.log('Calculate L2', l2TokenAddress);
  }
